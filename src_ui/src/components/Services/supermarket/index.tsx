...
class Supermarket extends Component<Props, State> {
	...
	selectCategory(category: Category) {
		this.setState(() => ({ activeCategory: category, selectedProduct: undefined }));
	}

	render() {
		const { prices, selectedProduct, activeCategory } = this.state;
		...
		return (
			<div className="supermarket">
				<div className="supermarket_container">
					...
					<Tabs active={activeCategory} onSelect={this.selectCategory.bind(this)} />
